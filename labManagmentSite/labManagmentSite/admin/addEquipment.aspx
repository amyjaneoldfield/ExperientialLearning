...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="mainPage" class="container">
        ...
        <div class="addEquipForm">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="* This filed cannot be left blank" CssClass="validation" ControlToValidate="txtAddEquipName"></asp:RequiredFieldValidator>
            <div class="addLblEquip">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="* This field cannot be left blank" CssClass="validation" ControlToValidate="txtAddEquipLocation"></asp:RequiredFieldValidator>
            <div class="addLblEquip">
                <asp:Label ID="lblAddEquipCustodian" runat="server" Text="Custodian" AssociatedControlID="txtAddEquipcustodian"></asp:Label>
            </div>
            <div>
                <asp:TextBox ID="txtAddEquipCustodian" runat="server" CssClass="txtAddEquip"></asp:TextBox>
            </div>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="* This field cannot be left blank" CssClass="validation" ControlToValidate="txtAddEquipCustodian"></asp:RequiredFieldValidator>
